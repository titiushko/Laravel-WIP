...
@section('header','Editar Publicacion')
@section('content')
...
<div class="container-fluid">
	...
	{{--  <div class="row">
	  ...
	  <div class="col-md-4">
	  	...
	  	<div class="form-group" style="width: 80%;">
				...
				{!! Form::select('curso_id',$cursos,null,['id'=>'curso_edit','class'=>'form-control','placeholder'=>'Seleccione Un Curso','required']) !!}
			</div>
	  </div>
	  ...
	  <div class="col-md-4">
	  	<div class="form-group" style="width:80%;">
				...
				{!! Form::select('modulos_id',['placeholder'=>'Seleccione un Modulo'],null,['id'=>'modulo_edit','class'=>'form-control','required']) !!}
			</div>
	  </div>
	  <div class="col-md-1"></div>
	</div>--}}
	...
	<div class="row">
		<div class="form-group">
			...
			{!! Form::text('titulo',$article->titulo,['class'=>'form-control','placeholder'=>'Escriba el titulo de su publicación','required']) !!}
		</div>
		
		<div class="form-group" >
			{!! Form::label('descripcion','Descripcion') !!}
			{!! Form::textarea('descripcion',$article->descripcion,['class'=>'form-control', 'rows'=>'3']) !!}
		...
		<div class="form-group">
			...
			{!! Form::textarea('contenido',$article->contenido,['class'=>'form-control', 'rows'=>'25','required']) !!}
		</div>
	</div>
	<div class="row">
		<div class="col-md-1"></div>
