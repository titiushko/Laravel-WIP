...
@section('title', 'Creación de Tipo de Clínica')
@section('content')
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h1 class="page-header"><i class="fa fa-file-text-o"></i> Creación de Tipo de Clínica</h1>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {!! Form::open(['route'=>'types.store', 'method'=>'POST', 'autocomplete'=>'off']) !!}
                    <fieldset>
