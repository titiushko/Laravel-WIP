...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h1 class="page-header"><i class="fa fa-file-text-o"></i> Creación de Usuario</h1>
        <ol class="breadcrumb">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    {!! Form::label('role', 'Rol') !!}
                                    {!! Form::select('role', ['Administrador'=>'Administrador', 'Usuario'=>'Usuario'], null, ['class'=>'form-control selectpicker', 'data-live-search'=>'true', 'data-size'=>'10', 'placeholder'=>'Seleccione un rol']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
